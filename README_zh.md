...
> 说明：本模板是个人学习与实验项目，维护以个人时间为准，更新不保证及时，也不代表上海交通大学官方模板或官方视觉识别规范。模板仅供上海交通大学学生在非商业学习、课程展示、答辩或学术汇报中制作 PPT 使用；不建议用于商业用途、商业模板分发，或任何可能暗示获得学校官方授权的场景。
...
--- 物品总数[2][0.45,0.55][transition=rise]
...
![Template preview](../assets/demo/game-kit.svg){#fig:phase}
...
- CSS/JS 固定从 `core/` 引入。
- 示例图片固定放在 `assets/`。
- Markdown 页面内引用图片时，路径相对生成后的 HTML，例如 `../assets/demo/game-kit.svg`。
